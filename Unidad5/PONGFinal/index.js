window.onload = () => {
    ...
    const rectangulo1 = new Rectangulo('gameArea',posicionXRectangulo1,posicionYRectangulo1,rectanguloWidth,rectanguloHeight,'#ffffff');
    const rectangulo2 = new Rectangulo('gameArea',posicionXRectangulo2,posicionYRectangulo2,rectanguloWidth,rectanguloHeight,'#ffffff');
    ...
    function moverBolas() {
        for (let bola of bolas) {
            ...
            // Verificar si la bola cruza los límites izquierdo o derecho
            if (bola.posX + bola.radio >= gameAreaWidth) {

                puntuacionJugador1 += 1;
                puntuacion1.textContent = puntuacionJugador1; 
            ...
            if (bola.posX - bola.radio <= 0) {
                ...
                puntuacion2.textContent = puntuacionJugador2; 
